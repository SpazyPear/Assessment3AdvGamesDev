...
void ATerrainGenerator::Tick(float DeltaTime)
{
	...
	if (SectionUpdateQueue.Num() > 0 && bAllowedToUpdateSection)
	{
		...
		SectionActors[SectionUpdateQueue[0]]->UpdateSection(); //used to be updatesections
	}
}
...
void ATerrainGenerator::InitializeProperties()
{
	...
	for (auto h = 0; h < SectionXY - 1; h++) {
		for (auto w = 0; w < SectionXY - 1; w++) {
			SectionProperties.Triangles.Add((h * SectionXY) + w);
			SectionProperties.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionProperties.Triangles.Add((h * SectionXY) + w + 1);
			SectionProperties.Triangles.Add((h * SectionXY) + w + 1);
			SectionProperties.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionProperties.Triangles.Add(((h + 1) * SectionXY) + w + 1);
		}
	}
	...
	for (auto h = 0; h < SectionXY - 1; h++) {
		for (auto w = 0; w < SectionXY - 1; w++) {
			SectionPropertiesLOD1.Triangles.Add((h * SectionXY) + w);
			SectionPropertiesLOD1.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD1.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD1.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD1.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD1.Triangles.Add(((h + 1) * SectionXY) + w + 1);
		}
	}
	...
	for (auto h = 0; h < SectionXY - 1; h++) {
		for (auto w = 0; w < SectionXY - 1; w++) {
			SectionPropertiesLOD2.Triangles.Add((h * SectionXY) + w);
			SectionPropertiesLOD2.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD2.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD2.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD2.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD2.Triangles.Add(((h + 1) * SectionXY) + w + 1);
		}
	}
	...
	for (auto h = 0; h < SectionXY - 1; h++) {
		for (auto w = 0; w < SectionXY - 1; w++) {
			SectionPropertiesLOD3.Triangles.Add((h * SectionXY) + w);
			SectionPropertiesLOD3.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD3.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD3.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD3.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD3.Triangles.Add(((h + 1) * SectionXY) + w + 1);
		}
	}
	...
	for (auto h = 0; h < SectionXY - 1; h++) {
		for (auto w = 0; w < SectionXY - 1; w++) {
			SectionPropertiesLOD4.Triangles.Add((h * SectionXY) + w);
			SectionPropertiesLOD4.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD4.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD4.Triangles.Add((h * SectionXY) + w + 1);
			SectionPropertiesLOD4.Triangles.Add(((h + 1) * SectionXY) + w);
			SectionPropertiesLOD4.Triangles.Add(((h + 1) * SectionXY) + w + 1);
		}
	}
