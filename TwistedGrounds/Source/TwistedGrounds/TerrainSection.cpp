...
ATerrainSection::ATerrainSection()
{
	...
	RuntimeMeshComponent = CreateDefaultSubobject<URuntimeMeshComponentStatic>(TEXT("RuntimeMeshComponent"));
	...
	// LOD1
	RuntimeMeshComponentLOD1 = CreateDefaultSubobject<URuntimeMeshComponentStatic>(TEXT("RuntimeMeshComponentLOD1"));
	...
	// LOD2
	RuntimeMeshComponentLOD2 = CreateDefaultSubobject<URuntimeMeshComponentStatic>(TEXT("RuntimeMeshComponentLOD2"));
	...
	// LOD3
	RuntimeMeshComponentLOD3 = CreateDefaultSubobject<URuntimeMeshComponentStatic>(TEXT("RuntimeMeshComponentLOD3"));
	...
	// LOD4
	RuntimeMeshComponentLOD4 = CreateDefaultSubobject<URuntimeMeshComponentStatic>(TEXT("RuntimeMeshComponentLOD4"));
...
void ATerrainSection::CreateSection()
{
	...
	if (bUseRuntimeMeshComponent)
	{
		...
		{
			RuntimeMeshLODs[i]->CreateSectionFromComponents(
				0,
				0,
				0,
...
void ATerrainSection::UpdateSection()
{
	...
	if (bUseRuntimeMeshComponent)
	{
		...
		for (int32 i = 0; i < RuntimeMeshLODs.Num(); i++)
		{
			RuntimeMeshLODs[i]->UpdateSectionFromComponents(
				0,
				0,
				OwningTerrain->LODProperties[i]->Vertices,
				OwningTerrain->LODProperties[i]->Triangles,
